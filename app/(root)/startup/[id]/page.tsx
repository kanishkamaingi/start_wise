  ...
  return (
    <>
      ...
      <section className='section_container'>
        <img className='w-full h-auto rounded-xl' src={post?.image} alt="picture" />
        <div className='space-y-5 mt-10 max-w-4xl mx-auto'>
            <div className='flex-between gap-g'> 
              <Link href={`/user/${post.author?._id}`} className='flex gap-3 items-center mb-3'>
